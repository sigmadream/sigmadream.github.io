...
* DBUG, 월 1회 `Django`를 사용한 취미 개발 중심의 hands-on 세션 진행할 예정
	* Django보다 HTML/CSS/JS 관련 부분만 계속해서 스터디 한다는 지적이 있어서 잠정적으로 스터디를 중단
	* 향후 Django에 집중할 수 있는 컨텍츠를 선택해서 재개할 예정

* 가능하다면 부산에서 작은 파이콘행사를 진행해 보고 싶음(이건 온전히 희망!)
	* 2019년 1월 6일에 [작은 모임 진행](https://docs.google.com/document/d/1_VKG1oP5EE0kbK2nJ6qPCWEEMzrBwIacBBOSyUknvCw/edit?usp=sharing)을 진행하였고, 3개의 스터디 그룹 진행
	* 2019년 6월, 3개의 스터디 그룹 중 1개는 계속해서 진행, 1개는 종료, 나머지 1개는 다른 주제로 진행 중
		* 파이썬 문법 및 기초 관련 스터디 요구사항이 많아서 관련 행사를 기획 중
...
* ~~`Kotlin`과 `Swift`을 병행해서 조금씩 공부(1~2분기)~~, 다른 내용이 많아서 취소
...
* ~~1/2분기, `Haskell` 문법 학습~~
* 3분기, SICP 연습문제 풀기
* 4분기, `Haskell`을 사용한 Microservice Architecture 구현 연습 및 정리
...
* JavaScript ES6 학습
	* 훗... 나도 `ES6` 사용해 봤음(잘한다고 한 적 없음)
* Node.js
	* `Express`를 `Node.js`로 등치시키면 훌륭한데, 그게 아니면 망했음
* React.js or Vue.js
	* `Vue.js`를 선택함으로써 다시 한 번 `마이너`의 삶을 경험하고 있음

## 엑셀을 잘 다루자!(~~데이터분석에 대해서 알아보자!~~, 2017년 못다한 나의 목표를 축소, 그러나 내년으로 가겠지?)
* 엑셀을 잘 다루자!
...
* 대학원 일정과 맞물려서 생각도 못해봤기 떄문에 2018년 목표로 재설정함~~(다이어트는 내일부터, 목표는 내년부터)~~
* 읽고 공부하려고 했던 책들~~(안 읽었다는 말임)~~
	* [회사에서 바로 통하는 엑셀 데이터 활용 + 분석](http://www.aladin.co.kr/shop/wproduct.aspx?ItemId=86488204)
	* [엑셀을 활용한 마케팅 분석 기법](http://www.aladin.co.kr/shop/wproduct.aspx?ItemId=54526377)
	* [앤더슨의 통계학](http://www.aladin.co.kr/shop/wproduct.aspx?ItemId=86829983)
